...
define([
    ...
    Locator.prototype.getNewsRegionChoices = function() {
        ...
        var _newsRegions, cookie, choices, i;
    ...
    Locator.prototype.getLocation = function() {
        ...
        getValues = function(store) {
            var index, name, values, value , data = {};
